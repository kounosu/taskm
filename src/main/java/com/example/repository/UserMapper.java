...
public interface UserMapper {
	...
	// IGNOREにより、初回のみ実行する
	// @Insert("INSERT IGNORE INTO GoogleUser (userid, sort) VALUES (#{userid},
	// 'date')")
	@Insert("INSERT INTO GoogleUser (userid, sort) VALUES (#{userID}, 'date') ON CONFLICT DO NOTHING")
	// @Insert("INSERT INTO GoogleUser (userid, sort) VALUES
	// ('matsuda.mutsumi61@gmail.com', 'date') ON CONFLICT DO NOTHING")
	...
	/**
	 * DeleteAll処理② ログイン中のユーザーのGoogleUserテーブルの情報を削除
	 * 
	 * @param userid
	 */
